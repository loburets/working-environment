storm:
	...
	alt + вверх 		- выделить текущий блок кода (в т.ч. строку) целиком (повторо переводит на уровень выше)
	alt + enter (edit)  - редактировать кусок кода на другом языке, например, строку с html, контекстно-независимо
	ctrl + I/O 			- работа с методоами предков/родителей
...
mac:
	...
	cmd + alt + space 	- поиск
	cmd + §				- консоль
	cmd + alt + стрелка - spectacle
	fn + f11 (cmd + f3)	- рабочий стол
	cmd + tab 			- смена окна
	ctrl + вверх 		- все окна
	ctrl + вниз 		- окна текущего приложения
